...
User.create(first_name: "Jaclyn", last_name: "Barr", email: "jaclynnbarrera@gmail.com", password: "password")
User.create(first_name: "Tyler", last_name: "Creator", email: "tyler@creator.com", password: "password")
